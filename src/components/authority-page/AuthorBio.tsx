      ...
      <div className="bg-[var(--bg-secondary)] rounded-lg p-6 md:p-8 border border-[var(--border)]">
        <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">Hunter Lapeyre</h3>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="inline-flex items-center px-3 py-1 rounded-full bg-[var(--accent)]/10 text-[var(--accent)] text-sm border border-[var(--accent)]/20">
                Former Contractor
              </span>
              <span className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 text-sm border border-emerald-500/20">
                50+ Clients Served
              </span>
              <span className="inline-flex items-center px-3 py-1 rounded-full bg-violet-500/10 text-violet-600 text-sm border border-violet-500/20">
                SEO/GEO Specialist
              </span>
            </div>

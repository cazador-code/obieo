          ...
          <div className="mt-8 space-y-4 text-slate-600 leading-relaxed">
            ...
            <ul className="space-y-3 ml-1">
              <li className="flex items-start gap-3">
                ...
                <span>Paying $2,500/month for &quot;SEO&quot; but can&apos;t explain what you&apos;re getting</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-terracotta-500 mt-1">→</span>
                <span>Monthly reports full of jargon and vanity metrics</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-terracotta-500 mt-1">→</span>
                <span>50 blog posts about &quot;the history of roofing&quot; that generate zero calls</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-terracotta-500 mt-1">→</span>
                <span>Promises of &quot;10 backlinks a month&quot; from sites you&apos;ve never heard of</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-terracotta-500 mt-1">→</span>
                <span>Six months in, still waiting for results</span>
              </li>
            </ul>
            <p className="pt-4">
            ...
            {[
              {
                ...
                description: 'Full optimization + 8–10 posts/month + review responses + photo uploads + Q&A management. Your GBP will actually look like you care.',
              },
              {
                title: '2 SEO Pages Per Month',
                description: 'Service pages, location pages, or FAQ pages — built to rank for real searches and convert visitors into calls. Quality over quantity.',
              },
              {
                title: 'Technical SEO',
                description: 'Site speed, mobile optimization, schema markup, crawl fixes, internal linking. The unsexy stuff that makes everything else work.',
              },
              {
                title: 'Local Citations',
                description: 'Month 1: 20–30 core directory listings. Ongoing: monitoring + cleanup. Consistent name/address/phone everywhere Google looks.',
              },
              {
                title: 'Quality Link Building',
                description: '2–4 real links per month from local sources, industry directories, and outreach. No PBNs, no spam — just links that actually help your site.',
              },
              {
                title: 'Monthly Reporting',
                description: 'One-page report + 15-minute video walkthrough. Rankings, traffic, GBP metrics, calls. Plain English, no jargon.',
              },
            ].map((item, i) => (
            ...
            {[
              {
                ...
                description: 'Every page built to show up in AI search results and featured snippets',
              },
              {
                title: 'Review Generation System',
                description: 'Templates + process to help you get more Google reviews (you still have to ask customers, but we make it easy)',
              },
              {
                title: 'Conversion Audit (Month 1)',
                description: 'We\'ll flag the top 5 things on your site killing conversions. Fix them or we\'ll quote it separately.',
              },
              {
                title: 'GA4 + Call Tracking Setup',
                description: 'So we both know what\'s actually working',
              },
            ].map((item, i) => (
            ...
            {[
              {
                period: 'Months 1–2',
                title: 'Foundation',
                description: 'We\'re auditing, fixing, optimizing, and building. Rankings may not move yet. This is normal.',
              },
              {
                period: 'Months 3–4',
                title: 'Movement',
                description: 'You\'ll see rankings improve on lower-competition keywords. GBP views and actions start climbing.',
              },
              {
                period: 'Months 5–6',
                title: 'Traction',
                description: 'Multiple first-page rankings. More calls from GBP. Organic traffic clearly trending up.',
              },
              {
                period: 'Months 6–12',
                title: 'Compounding',
                description: 'This is where SEO pays off. Rankings stick. Leads increase. Competitors wonder what happened.',
              },
            ].map((item, i) => (
              <div key={i} className="flex gap-6">
                <div className="flex flex-col items-center">
                  ...
                  {i < 3 && <div className="w-0.5 h-full bg-terracotta-200 mt-2" />}
                </div>
                <div className="pb-8">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              {
                title: 'Owners who want more calls, not more meetings',
                description: 'You don\'t want a marketing team. You want a marketing partner who handles it.',
              },
              {
                title: 'Businesses in markets with real competition',
                description: 'If you\'re in a mid-size metro and competitors are outranking you, this fixes that.',
              },
              {
                title: 'People who\'ve been burned before',
                description: 'Skeptical of agencies? Good. We\'ll earn your trust with results, not promises.',
              },
            ].map((item, i) => (
